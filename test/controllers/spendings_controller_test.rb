...
class SpendingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spending" do
    assert_difference('Spending.count') do
      post spendings_url, params: { spending: { amount: @spending.amount, description: @spending.description, spending_date: @spending.spending_date } }
    end
  ...
  test "should update spending" do
    patch spending_url(@spending), params: { spending: { amount: @spending.amount, description: @spending.description, spending_date: @spending.spending_date } }
